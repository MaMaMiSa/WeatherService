	$(document).ready(function(){
            ...
            xmlhttp.onreadystatechange = function () {
                if (xmlhttp.readyState === 4) {
                    if (xmlhttp.status === 200) {
                        ...
                        var node = xmlhttp.responseXML.getElementsByTagName("return")[0];
                        var res = null; 
                        if(node !== undefined)
		...
		function forecast_update(location_forecast) {
			...
			/* Soap message Web service : WeatherService/ForecastService */
                        var sr_actualize_information 	= '<ns2:actualizeInformation xmlns:ns2="http://weather.mamamisa.com/">' + p + '</ns2:actualizeInformation>';
			...
			var wind_direction_cb = function (res) {
				document.getElementById("div_wind_direction").innerHTML = '<img src="images/icon-compass.png" alt="">' + res + '</span>';
                        ...
                        var actualize_information_cb = function (res) {
                            // Not implemented;
                            console.log(res);
                             console.log("YOOO");
			...
			/* Send request */
                        sendSoapRequest(sr_begin + sr_actualize_information + sr_end, actualize_information_cb);
